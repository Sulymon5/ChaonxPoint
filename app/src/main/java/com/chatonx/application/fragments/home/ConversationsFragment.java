package com.chatonx.application.fragments.home;
...
import com.chatonx.application.adapters.recyclerView.messages.ConversationsAdapter;
...
import com.chatonx.application.presenters.messages.ConversationsPresenter;
import com.chatonx.application.services.MainService;
import com.chatonx.application.ui.CustomProgressView;
...
import static com.chatonx.application.app.AppConstants.EVENT_BUS_ACTION_MODE_FINISHED;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_CONTACTS_PERMISSION;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_CREATE_NEW_GROUP;
...
import static com.chatonx.application.app.AppConstants.EVENT_BUS_IMAGE_GROUP_UPDATED;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_ITEM_IS_ACTIVATED;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_MESSAGE_COUNTER;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_MESSAGE_IS_DELIVERED_FOR_CONVERSATIONS;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_MESSAGE_IS_READ;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_MESSAGE_IS_SEEN_FOR_CONVERSATIONS;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_NEW_MESSAGE_CONVERSATION_NEW_ROW;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_NEW_MESSAGE_CONVERSATION_OLD_ROW;
import static com.chatonx.application.app.AppConstants.EVENT_BUS_NEW_MESSAGE_IS_SENT_FOR_CONVERSATIONS;
import static com.chatonx.application.app.AppConstants.EVENT_UPDATE_CONVERSATION_OLD_ROW;
...
public class ConversationsFragment extends Fragment implements LoadingData, RecyclerView.OnItemTouchListener, ActionMode.Callback {
    ...
    private void initializerView() {
        ...
        mConversationsAdapter = new ConversationsAdapter(ConversationList);
    ...
    public void sendGroupMessage(GroupsModel groupsModel, MessagesModel messagesModel) {
        Realm realmCreateGroup = ChatonXApplication.getRealmDatabaseInstance();
...
/*
            ...
            case AppConstants.EVENT_BUS_UPDATE_USER_STATE:
                if (pusher.getData().equals(AppConstants.EVENT_BUS_USER_IS_ONLINE))
                    mConversationsAdapter.updateItem(pusher.getUserID(), true);
                else if (pusher.getData().equals(AppConstants.EVENT_BUS_USER_IS_OFFLINE))
                    mConversationsAdapter.updateItem(pusher.getUserID(), false);
                break;
