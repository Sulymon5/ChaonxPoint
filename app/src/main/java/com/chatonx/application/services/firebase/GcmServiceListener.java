    ...
    private void saveNewMessage(JSONObject data) {
        ...
        try {
            ...
            AppHelper.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    new Handler().postDelayed(() -> {
                        MainService.RecipientMarkMessageAsDelivered(GcmServiceListener.this, messageId, senderId);
            ...
            AppHelper.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    new Handler().postDelayed(() -> {
                        if (AppHelper.isActivityRunning(GcmServiceListener.this, "activities.messages.MessagesActivity")) {
                            AppHelper.LogCat("MessagesActivity running");
                            MainService.emitMessageSeen(GcmServiceListener.this, senderId);
                        }
                    }, 2000);
    ...
    private void saveNewMessageGroup(JSONObject data) {
        ...
        try {
            ...
            AppHelper.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    new Handler().postDelayed(() -> {
                        MainService.RecipientMarkMessageAsDeliveredGroup(GcmServiceListener.this, groupID);
                    }, 1200);
                }
            });
            ...
            AppHelper.runOnUIThread(new Runnable() {
                ...
                public void run() {
                    ...
                    new Handler().postDelayed(() -> {
                        if (AppHelper.isActivityRunning(GcmServiceListener.this, "activities.messages.MessagesActivity")) {
                            AppHelper.LogCat("MessagesActivity running");
                            MainService.RecipientMarkMessageAsSeenGroup(GcmServiceListener.this, groupID);
                        }
                    }, 2000);
