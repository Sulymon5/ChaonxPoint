...
import com.chatonx.application.activities.CountryActivity;
...
import com.chatonx.application.helpers.CountriesFetcher;
...
import com.chatonx.application.models.CountriesModel;
import com.chatonx.application.models.auth.LoginModel;
import com.chatonx.application.services.SMSVerificationService;
...
public class WelcomeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void getAppSettings() {
        mDisposable.add(APIHelper.initialApiUsersContacts().getAppSettings().subscribe(settingsResponse -> {
            ...
            if (PreferenceManager.getVersionApp(ChatonXApplication.getInstance()) != 0) {
                currentAppVersion = PreferenceManager.getVersionApp(ChatonXApplication.getInstance());
            } else {
                currentAppVersion = AppHelper.getAppVersionCode(ChatonXApplication.getInstance());
            }
    ...
    private void requestForSMS(String mobile, String country) {
        ...
        APIHelper.initializeAuthService().join(loginModel).subscribe(joinModelResponse -> {
            if (joinModelResponse.isSuccess()) {
