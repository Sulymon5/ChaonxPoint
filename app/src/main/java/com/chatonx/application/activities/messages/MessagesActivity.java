...
import com.chatonx.application.presenters.messages.MessagesPresenter;
import com.chatonx.application.services.MainService;
import com.chatonx.application.ui.ColorGenerator;
import com.chatonx.application.ui.HideShowScrollListener;
            ...
            new AsyncTask<Void, Void, Bitmap>() {
                ...
                protected void onPostExecute(Bitmap bitmap) {
                    ...
                    if (bitmap != null) {
                        ...
                        mView.setBackground(AppHelper.getDrawable(MessagesActivity.this, R.drawable.bg_bck));
                    }
                }
            }.execute();
                       ...
                       /*     if (AppHelper.isAndroid7()) {
                           ...
                           /* if (AppHelper.isAndroid7()) {
                            ...
                            if (FileVideoThumbnailPath == null) {
                                FileVideoThumbnailPath = FilesManager.copyDocumentToCache(Uri.fromFile(fileVideo), ".mp4");
                            }
    ...
    private List<MessagesModel> FilterList(String query) {
        ...
        if (isGroup) {
            ...
            messagesModels = realm.where(MessagesModel.class)
                    ...
                    .equalTo("conversationID", ConversationID)
                    .equalTo("isGroup", true).sort("id", Sort.ASCENDING).findAll();
        } else {
