...
import com.chatonx.application.helpers.call.PeerConnectionParameters;
import com.chatonx.application.helpers.call.WebRtcClient;
import com.chatonx.application.helpers.images.BlurTransformationPicasso;
import com.chatonx.application.models.calls.CallPusher;
...
public class CallActivity extends Activity {
    ...
    private void initializerView() {
        ...
        if (isAccepted) {
            ...
            String name = UtilsPhone.getContactName(callerPhoneAccept);
            if (name != null) {
            ...
            String name = UtilsPhone.getContactName(callerPhone);
            if (name != null) {
                callerPhoneField.setVisibility(View.VISIBLE);
                callerPhoneField.setText(name);
            } else {
            ...
            runOnUiThread(() -> {
                ...
                switch (bandwidthState) {
                    case EXCELLENT:
                        ...
                        break;
                    case MODERATE:
                        connectionStatus.setText(getString(R.string.you_are_using_a_moderate_connection));
                        new Handler().postDelayed(() -> {
                            connectionStatus.setVisibility(View.GONE);
                        }, 4000);
                        break;
                    case POOR:
                        connectionStatus.setText(getString(R.string.you_are_using_a_poor_connection));
                        AppHelper.CustomToast(ChatonXApplication.getInstance(), getString(R.string.you_are_using_a_poor_connection));
                        new Handler().postDelayed(() -> {
                            connectionStatus.setVisibility(View.GONE);
                        }, 4000);
                        break;
                    case GOOD:
                        connectionStatus.setText(getString(R.string.you_are_using_a_good_connection));
                        new Handler().postDelayed(() -> {
                            connectionStatus.setVisibility(View.GONE);
                        }, 4000);
                        break;
                    case UNKNOWN:
                        connectionStatus.setText(getString(R.string.connection_is_not_available));
                        new Handler().postDelayed(() -> {
                            connectionStatus.setVisibility(View.GONE);
                        }, 4000);
                        hangUp();
        ...
        networkMonitorAutoDetect = new NetworkMonitorAutoDetect(connectionType -> {
            ...
            switch (connectionType) {
                ...
                case CONNECTION_UNKNOWN:
                    ...
                    new Handler().postDelayed(this::hangUp, 2000);
    ...
    private void getCallerInfo() {
        ...
        String image = mContactsModel.getImage();
    ...
    private void updateUserCall() {
        ...
        realm.executeTransaction(realm1 -> {
            ...
            if (isAccepted) {
                ...
                mDisposable.addAll(APIHelper.initialApiUsersContacts().saveAcceptedCall(callSaverModel).subscribe(Response -> {
                ...
                callSaverModel.setDuration(getTimer());
                callSaverModel.setIsVideo(isVideo);
                mDisposable.addAll(APIHelper.initialApiUsersContacts().saveEmittedCall(callSaverModel).subscribe(Response -> {
