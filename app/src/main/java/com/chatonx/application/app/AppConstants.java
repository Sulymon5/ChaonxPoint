...
import static com.chatonx.application.app.ChatonXApplication.getInstance;

/**
 * Created by olatech101 mac
 */
public class AppConstants {

    /* debugging constants  for developer */
    public static final String TAG = "olatech";
    public static final boolean ENABLE_FONTS_TYPES = false; //this to changes fonts of the application
    public static final boolean DEBUGGING_MODE = false; //mode to check the error on mobile this is only for developer once your app is ready make the status as false
    ...
    public static final String DEFAULT_COUNTRY_CODE = "NG";// this for  country code

    public static final int DatabaseVersion = 1;
    public static final String DatabaseName = getInstance().getString(R.string.app_name) + PreferenceManager.getToken(getInstance()) + "_db" + ".realm";
    /**
     * for the application
     */
    static final String APP_KEY_SECRET = "7d3d3b6c2d3683bf25bbb51533ec6chaton";// make sure this one is the same that you put on your server side (for security reasons)
    public static final String INVITE_MESSAGE_SMS = "Hello get " + getInstance().getString(R.string.app_name) + " so we can easily chat  with each other !  ";// this is the sms to invite  friends
    public static final String JOINED_MESSAGE_SMS = "Hi there! i'm using " + getInstance().getString(R.string.app_name);// this is the msg when the user join to the app
