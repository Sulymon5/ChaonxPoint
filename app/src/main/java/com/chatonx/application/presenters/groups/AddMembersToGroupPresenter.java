...
public class AddMembersToGroupPresenter implements Presenter {
    ...
    public void onCreate() {
        ...
        mDisposable.addAll(mUsersContacts.getLinkedContacts().subscribe(view::ShowContacts, throwable -> AppHelper.LogCat("AddMembersToGroupPresenter " + throwable.getMessage())));
