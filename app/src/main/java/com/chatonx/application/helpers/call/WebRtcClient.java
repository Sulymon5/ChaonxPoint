package com.chatonx.application.helpers.call;
...
public class WebRtcClient {
    ...
    public void signalingServer(String to, String type, JSONObject payload) throws JSONException {
        ...
        message.put("to", to);
        message.put("from", PreferenceManager.getSocketID(ChatonXApplication.getInstance()));
    ...
    private class SignalingServerHandler {
        ...
        private Emitter.Listener onRejectResponse = args -> {
            ...
            try {
                ...
                if (from.equals(PreferenceManager.getSocketID(ChatonXApplication.getInstance())))
                    return;
    ...
    public WebRtcClient(Activity mActivity, PeerConnectionParameters params, String currentUserConnectedID, String callerSocketId, boolean isVideoCall, boolean isAccepted) {
        ...
        ChatonXApplication app = (ChatonXApplication) mActivity.getApplication();
            ...
            try {
                ...
                mSocket.emit(AppConstants.SOCKET_RESET_SOCKET_ID, message, (Ack) args -> {
                    ...
                    try {
                        ...
                        if (!id.equals(PreferenceManager.getSocketID(ChatonXApplication.getInstance()))) {
                            mActivity.finish();
                        } else {
        ...
        iceServers.add(new PeerConnection.IceServer("turn:numb.viagenie.ca:3478", "tutos.academy@gmail.com", "bencherif"));
